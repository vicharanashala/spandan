# Version 0.13 — Question Review & Moderation
...
verification checklist for Version 0.13 of the Spandan platform.

This version focuses on:

- Question Review & Moderation
...
- All previous stable versions before v0.13
...
| ID | Requirement |
|---|---|
| FR-1 | Feature set for Question Review & Moderation must work independently |
