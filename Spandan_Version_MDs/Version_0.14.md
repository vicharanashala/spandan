# Version 0.14 — Live Question Broadcasting
...
verification checklist for Version 0.14 of the Spandan platform.
...
- All previous stable versions before v0.14
...
| ID | Requirement |
|---|---|
| FR-1 | Feature set for Live Question Broadcasting must work independently |
