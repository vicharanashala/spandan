# Version 0.17 — Leaderboard Engine
...
verification checklist for Version 0.17 of the Spandan platform.
...
- All previous stable versions before v0.17
...
| ID | Requirement |
|---|---|
| FR-1 | Feature set for Leaderboard Engine must work independently |
