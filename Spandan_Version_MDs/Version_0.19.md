# Version 0.19 — CSV Export & Session Analytics
...
verification checklist for Version 0.19 of the Spandan platform.

This version focuses on:

- CSV Export & Session Analytics
...
- All previous stable versions before v0.19
...
| ID | Requirement |
|---|---|
| FR-1 | Feature set for CSV Export & Session Analytics must work independently |
