# Version 0.2 — MongoDB Models & Database Schema
...
verification checklist for Version 0.2 of the Spandan platform.

This version focuses on:

- MongoDB Models & Database Schema
...
- All previous stable versions before v0.2
...
| ID | Requirement |
|---|---|
| FR-1 | Feature set for MongoDB Models & Database Schema must work independently |
