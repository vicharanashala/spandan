# Version 0.20 — Co-Host & Temporary Invite Links
...
verification checklist for Version 0.20 of the Spandan platform.

This version focuses on:

- Co-Host & Temporary Invite Links
...
- All previous stable versions before v0.20
...
| ID | Requirement |
|---|---|
| FR-1 | Feature set for Co-Host & Temporary Invite Links must work independently |
