# Version 0.3 — Authentication Backend
...
verification checklist for Version 0.3 of the Spandan platform.
...
- All previous stable versions before v0.3
...
| ID | Requirement |
|---|---|
| FR-1 | Feature set for Authentication Backend must work independently |
