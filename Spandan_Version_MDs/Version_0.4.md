# Version 0.4 — Authentication Frontend
...
verification checklist for Version 0.4 of the Spandan platform.
...
- All previous stable versions before v0.4
...
| ID | Requirement |
|---|---|
| FR-1 | Feature set for Authentication Frontend must work independently |
