# Version 0.5 — Role Toggle System
...
verification checklist for Version 0.5 of the Spandan platform.
...
- All previous stable versions before v0.5
...
| ID | Requirement |
|---|---|
| FR-1 | Feature set for Role Toggle System must work independently |
