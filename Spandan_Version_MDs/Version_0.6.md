# Version 0.6 — Structured Dashboard Shells
...
verification checklist for Version 0.6 of the Spandan platform.

This version focuses on:

- Structured Dashboard Shells
...
- All previous stable versions before v0.6
...
| ID | Requirement |
|---|---|
| FR-1 | Feature set for Structured Dashboard Shells must work independently |
