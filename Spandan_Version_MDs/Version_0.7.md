...
verification checklist for Version 0.7 of the Spandan platform.
...
- All previous stable versions before v0.7
...
| ID | Requirement |
|---|---|
| FR-1 | Feature set for Room Lifecycle must work independently |
