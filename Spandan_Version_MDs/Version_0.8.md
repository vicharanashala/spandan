# Version 0.8 — Socket.IO Real-Time Foundation
...
verification checklist for Version 0.8 of the Spandan platform.
...
- All previous stable versions before v0.8
...
| ID | Requirement |
|---|---|
| FR-1 | Feature set for Socket.IO Real-Time Foundation must work independently |
