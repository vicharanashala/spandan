# Version 0.9 — Audio Recording & Streaming
...
verification checklist for Version 0.9 of the Spandan platform.
...
- All previous stable versions before v0.9
...
| ID | Requirement |
|---|---|
| FR-1 | Feature set for Audio Recording & Streaming must work independently |
