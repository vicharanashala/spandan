...
import PeerDiscussionPanel from '../components/PeerDiscussionPanel'
import PeerDiscussionTeacherPanel from '../components/PeerDiscussionTeacherPanel'
    ...
    <div style={{
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', marginLeft: '240px' }}>
        ...
        <div style={{ flex: 1, padding: '32px' }}>
          ...
          {/* Peer Discussion — post-quiz only, never shown during a live room */}
          {user?.role === 'teacher' ? (
            <PeerDiscussionTeacherPanel roomId={roomId} token={token} />
          ) : (
            <PeerDiscussionPanel roomId={roomId} questions={questions} token={token} user={user} />
          )}
