...
public class KafkaConfig {
    ...
    @Bean
    public NewTopic notificationEventsTopic(@Value("${kafka.topics.notification-events}") String topic) {
    ...
    public ConsumerFactory<String, EventEnvelope> consumerFactory() {
        ...
        props.put(JsonDeserializer.TYPE_MAPPINGS, "event:com.spandan.notification.application.dto.event.EventEnvelope");
